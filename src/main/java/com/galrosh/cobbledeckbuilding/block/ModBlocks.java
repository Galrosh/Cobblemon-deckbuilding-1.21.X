...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(CobbleDeckBuilding.MODID);


    public static final DeferredBlock<Block> FOIL_BLOCK = registerBlock("foil_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(4f).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));

    public static final DeferredBlock<Block> FOIL_ORE = registerBlock("foil_ore",
